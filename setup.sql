...
ALTER TABLE "regreso_destination" ADD CONSTRAINT "regreso_destination_workspace_id_regreso_workspace_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."regreso_workspace"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "regreso_list" ADD CONSTRAINT "regreso_list_workspace_id_regreso_workspace_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."regreso_workspace"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "regreso_tag" ADD CONSTRAINT "regreso_tag_workspace_id_regreso_workspace_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."regreso_workspace"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "regreso_user" ADD CONSTRAINT "regreso_user_workspace_id_regreso_workspace_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."regreso_workspace"("id") ON DELETE no action ON UPDATE no action;
