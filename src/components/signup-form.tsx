...
export function SignupForm() {
  // TODO: Replace onSubmit with action
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
            <LabelInputContainer>
              ...
              <Input id="firstname" placeholder="Pelican" type="text" />
            </LabelInputContainer>
            <LabelInputContainer>
              <Label htmlFor="lastname">Last name</Label>
              <Input id="lastname" placeholder="Steve" type="text" />
            </LabelInputContainer>
          </div>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="email">Email Address</Label>
            <Input id="email" placeholder="steve@pelicans.dev" type="email" />
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
