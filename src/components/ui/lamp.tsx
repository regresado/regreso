...
const LampContainer = memo(
  ({
    ...
    return (
      <div
        className={`relative z-0 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-white dark:bg-slate-950 ${className}`}
      >
        <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
          ...
          >
            <div className="absolute bottom-0 right-0 z-20 h-[100%] w-40 bg-white [mask-image:linear-gradient(to_left,white,transparent)] dark:bg-slate-950" />
        ...
        <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 pt-72">
