...
type SidebarContext = {
  ...
  setOpenMobile: (side: "left" | "right", open: boolean) => void;
  isMobile: boolean;
...
const SidebarProvider = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    onOpenChange?: (side: "left" | "right", open: boolean) => void;
  }
>((props, ref) => {
  ...
  const setOpenMobile = React.useCallback(
    (side: "left" | "right", open: boolean) => {
      _setOpenMobile((prev) => ({ ...prev, [side]: open }));
    },
    [],
  );
  ...
  const toggleSidebar = React.useCallback(
    (side: "left" | "right") => {
      if (isMobile) {
        setOpenMobile(side, !openMobile[side]);
      } else {
